  ...
  return (
    <div className="DisasterComponents">
      ...
      >
        ...
        {sData ? 
        <>
          <span>前後:{sData.beforeAfter ?  sData.beforeAfter : '無資料'}</span>
          <span>過程:{sData.maxDuring ? sData.maxDuring : '無資料'}</span>
        </>:
        <>
          <span>前後:{isData.postEventHealth}%</span>
          <span>過程:{isData.postEventHealth}%</span>
        </>
        }
